...
const ayarlar = require('../../../b-database.json');
const { green } = require("../../../b-database.json")

exports.run = async (client, message, args) => {

  if (ayarlar.Owner.includes(message.author.id) === false) return message.channel.send(`**Bu komutu sadece **${ayarlar.Owner}** kullanabilir!**`);
