...
const { star, green, red } = require("../../../../a-emoji.json")
...
kayitchannel.wsend(`
Revulion'a Hoşgeldin ${member}! Hesabın ${memberGün} ${memberAylar} ${memberTarih} tarihinde oluşturulmuş. ${guvenilirlik ? `Şüpheli! ${red}` : `Güvenli! ${green}` }\n 
